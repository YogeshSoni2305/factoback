...
# save_to_file = RESULT_DIR / "claim_fighter_results.md"
...
#     def __init__(self):
#         load_dotenv("api.key")
#         self.groq_key = os.getenv("GROQ_API_KEY") or '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' 
#         self.gemini_key = os.getenv("GEMINI_API_KEY") or 'AIzaSyCrldSkPekhP0LnvTHFBH02TUuDDxyeL_Y'
#         self.tavily_key = os.getenv("TAVILY_API_KEY") or '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'
...
#     def save_to_markdown(self, content, filename=RESULT_DIR / "claim_fighter_results.md", mode="a"):
...
#     "image": str(BASE_DIR / "data" / "donald.jpg"),
#     "video": None,
#     "audio": str(BASE_DIR / "data" / "donaltrump.mp3"),
